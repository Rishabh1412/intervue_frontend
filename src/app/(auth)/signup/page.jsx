    ...
    <div className="login-page">
      ...
      <form className="form">
        ...
        <div className="inputForm">
          ...
          <input type="email" className="input text-gray-700" placeholder="Enter your Email" name="email" />
        </div>
        ...
        <div className="inputForm">
          ...
          <input type="password" className="input text-gray-700" placeholder="Enter your Password" name="password" />
        </div>

        <button className="button-submit">Register</button>
        <p className="p">Alreay have an account? <a href='/login'><span className="span">Sign In</span></a></p>
      </form>
    </div>
  );
};
